...
export default function PageLoader<TData>(props: PageLoader<TData>) {
  ...
  if (query.isLoading) {
    ...
    return (
      <div className="min-h-screen rounded-sleek fade ring mt-4 grid place-items-center bg-base-200">
  ...
  if (query.isError) {
    ...
    return (
      <>
        <div className="p-4 min-h-screen mt-4 ring fade grid place-items-center bg-base-300/50 rounded-md">
